...
- the labeling for alignment plots generated by `alignmentplot` has to save in an Excel file with 2 column names:
  * __GroupNumber__: following the sequence in Mplus output, and
  * __GroupLabel__, equivalently
